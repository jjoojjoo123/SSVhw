			...
			\begin{itemize}
				...
				\begin{enumerate}
					...
					\begin{align*}
						...
						\Rightarrow ~& \mathcal{M}\llbracket S_{1} \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket wlp(S_{2}, q) \rrbracket\\
						&\{\text{Induction Hypothesis}\}\\
						\Rightarrow ~& \mathcal{M}\llbracket S_{2} \rrbracket(\mathcal{M} \llbracket S_{1} \rrbracket (\llbracket p \rrbracket)) \subseteq \llbracket q \rrbracket\\
						\equiv ~& \mathcal{M} \llbracket S_{1};S_{2} \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket\\
					\end{align*}
					\item $\mathcal{M} \llbracket S_{1};S_{2} \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket \to \llbracket p \rrbracket \subseteq \llbracket wlp(S_{1}, wlp(S_{2}, q)) \rrbracket$
					\begin{align*}
						& \mathcal{M} \llbracket S_{1};S_{2} \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket\\
						\equiv ~& \mathcal{M}\llbracket S_{2} \rrbracket(\mathcal{M} \llbracket S_{1} \rrbracket (\llbracket p \rrbracket)) \subseteq \llbracket q \rrbracket\\
						&\{\text{Induction Hypothesis}\}\\
						\Rightarrow ~& \mathcal{M}\llbracket S_{1} \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket wlp(S_{2}, q) \rrbracket\\
						&\{\text{Induction Hypothesis}\}\\
						\Rightarrow ~& \llbracket p \rrbracket \subseteq \llbracket wlp(S_{1}, wlp(S_{2}, q)) \rrbracket
					\end{align*}
				\end{enumerate}
				\item Conditional : $S\equiv$ \textbf{if} $B$ \textbf{then} $S_{1}$ \textbf{else} $S_{2}$ \textbf{fi}
				\begin{enumerate}
					\item $\llbracket p \rrbracket \subseteq \llbracket wlp(S, q) \rrbracket \to \mathcal{M} \llbracket S \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket$
					\begin{align*}
						...
						\end{cases}\\
						\Rightarrow ~& \mathcal{M}\llbracket S_{1} \rrbracket (\llbracket p \land B \rrbracket) \cup \mathcal{M}\llbracket S_{2} \rrbracket (\llbracket p \land \neg B \rrbracket) \subseteq \llbracket q \rrbracket\\
						\Rightarrow ~& \mathcal{M}\llbracket S_{1} \rrbracket (\llbracket p \rrbracket \cap \llbracket B \rrbracket) \cup \mathcal{M}\llbracket S_{2} \rrbracket (\llbracket p \rrbracket \cap \llbracket \neg B \rrbracket) \subseteq \llbracket q \rrbracket\\
						\equiv ~& \mathcal{M} \llbracket S \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket
					\end{align*}
					\item $\mathcal{M} \llbracket S \rrbracket(\llbracket p \rrbracket) \subseteq \llbracket q \rrbracket \to \llbracket p \rrbracket \subseteq \llbracket wlp(S, q) \rrbracket$ is similar.
				\end{enumerate}
			\end{itemize}
